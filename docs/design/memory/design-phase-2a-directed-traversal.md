...
**Class:** DESIGN
**Status:** Intent sketch — **superseded for implementation** by [design-phase-2a-implementation.md](design-phase-2a-implementation.md). **Code shipped** PR-A1–A5 (2026-07-29); architecture: [architecture/phase-2a-directed-traversal.md](../../state/memory/architecture/phase-2a-directed-traversal.md). Flags default **off**; operator dogfood pending.
...
- [x] Architecture note: [architecture/phase-2a-directed-traversal.md](../../state/memory/architecture/phase-2a-directed-traversal.md)
