...
5. **Documentation before code.** Designs live under DESIGN before implementation begins (historical GI branch: `grok-improvement`).
...
7. **Hybrid Decide.** Soft Decide (bias, orient cadence, handover vocabulary) is the MC surface. Hard host policies (speak→glass, skill-commit, thrash, continuous gates, usage) stay where they are — do not consolidate enforcement into an MC god module. See [metacognition.md](../design/grok-improvement-plan/metacognition.md) §3 and [docs/dev/engineering-principles.md](../dev/engineering-principles.md).

## Index (this folder + DESIGN homes)
...
Full design (implementation spec, not operator short-form): [`docs/design/usage/design-usage-tracking-supergrok-pacing.md`](../design/usage/design-usage-tracking-supergrok-pacing.md).
...
| **After Phase 0 stable** | **Stage B MC (MC-beta):** ledger-aware soft bias + short Decide cadence + status/answer-speak vocabulary. Still **no** new subsystem / package. Plan: [stage-b-mc.md](../design/grok-improvement-plan/stage-b-mc.md). |
...
MC **package** form only if self-mod needs an inspectable process body or Memory needs a durable process peer. **Not** “first real MC” — Stage B is the first behavioral MC. See [metacognition.md](../design/grok-improvement-plan/metacognition.md).
...
Execution detail (Phase 0 PR stack): [phase-0-execution.md](../design/grok-improvement-plan/phase-0-execution.md).  
Stage B execution: [stage-b-mc.md](../design/grok-improvement-plan/stage-b-mc.md).
