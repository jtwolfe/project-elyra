...
- **Metacognition**: Concept documented. Naming allowed now; form only after Grok path is stable (post Phase 0 + H live smoke). Prefer H-series green before MC Stage B.
