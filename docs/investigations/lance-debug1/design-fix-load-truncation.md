...
| **Sealed root cause** | [`docs/investigations/lance-debug1/BUG-DOSSIER.md`](docs/investigations/lance-debug1/BUG-DOSSIER.md) |
| **Evidence run** | `docs/investigations/lance-debug1/evidence/2026-07-29-run-01/` |
| **Inspection package** | `docs/investigations/lance-debug1/` (inspection complete; this design authorizes the **product** fix) |
...
Call matrix (authoritative inventory): [`docs/investigations/lance-debug1/TO-ARROW-CALLERS.md`](docs/investigations/lance-debug1/TO-ARROW-CALLERS.md).
...
From [`TO-ARROW-CALLERS.md`](docs/investigations/lance-debug1/TO-ARROW-CALLERS.md) + live grep of `elyra/memory/lance_store.py`.
...
- `docs/investigations/lance-debug1/scripts/fixtures/build_tiny_atoms.py` builds 25 rows for **api_matrix** plumbing — incomplete Atom schema (not enough for full `LanceMemoryStore._load`).
...
- [`docs/investigations/lance-debug1/BUG-DOSSIER.md`](docs/investigations/lance-debug1/BUG-DOSSIER.md) — sealed root cause
- [`docs/investigations/lance-debug1/TO-ARROW-CALLERS.md`](docs/investigations/lance-debug1/TO-ARROW-CALLERS.md) — call matrix
- [`docs/investigations/lance-debug1/CODE-PATH-MAP.md`](docs/investigations/lance-debug1/CODE-PATH-MAP.md) — open/load/consumer map
- [`docs/investigations/lance-debug1/API-COMPARISON.md`](docs/investigations/lance-debug1/API-COMPARISON.md) — H1/H1a/H1b/H2 numbers
- [`docs/investigations/lance-debug1/evidence/2026-07-29-run-01/`](docs/investigations/lance-debug1/evidence/2026-07-29-run-01/) — sealed bag
...
| **Files** | `docs/state/known-bugs.md` (add **BUG-mem-lance-01** Status=Fixed, link design + fix SHAs); `docs/investigations/lance-debug1/README.md` (status: inspection complete, **product fix landed** in elyra/memory); optional short note on `BUG-DOSSIER.md` header; optional post-fix evidence note |
...
*End of design (rev.2). Normative for product fix PRs; inspection package `docs/investigations/lance-debug1` remains evidence, not the fix implementation.*
