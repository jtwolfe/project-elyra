...
Usage (from repo root):
  python docs/investigations/lance-debug1/scripts/api_matrix.py --uri PATH --out PATH.json
  python docs/investigations/lance-debug1/scripts/api_matrix.py --uri \"$LANCE_DEBUG_URI\" \\
      --table atoms --out docs/investigations/lance-debug1/evidence/YYYY-MM-DD-run-01/api-matrix.json
