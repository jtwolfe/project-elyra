...
Usage (from repo root):
  ...
  python docs/investigations/lance-debug1/scripts/caller_grep_report.py --root /path/to/repo
...
def _repo_root_from_script() -> Path:
    # docs/investigations/lance-debug1/scripts/this_file.py → repo root
...
def main(argv: list[str] | None = None) -> int:
    ...
    print()
    print("Paste into `docs/investigations/lance-debug1/TO-ARROW-CALLERS.md` after review.")
    return 0
