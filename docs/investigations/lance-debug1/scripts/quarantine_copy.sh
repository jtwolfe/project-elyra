...
#
# Usage:
#   ./docs/investigations/lance-debug1/scripts/quarantine_copy.sh <SRC_MEMORY_ROOT> <QUARANTINE_ROOT>
# Example:
#   ./docs/investigations/lance-debug1/scripts/quarantine_copy.sh data/memory /tmp/lance-q-20260729
#
...
echo "  python docs/investigations/lance-debug1/scripts/api_matrix.py --uri \"\$LANCE_DEBUG_URI\" --out docs/investigations/lance-debug1/evidence/\$(date +%Y-%m-%d)-run-01/api-matrix.json"
