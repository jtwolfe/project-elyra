...
Usage (from repo root):
  ...
  python docs/investigations/lance-debug1/scripts/load_parity.py \\
    ...
    --api-matrix docs/investigations/lance-debug1/evidence/YYYY-MM-DD-run-01/api-matrix.json \\
    --out docs/investigations/lance-debug1/evidence/YYYY-MM-DD-run-01/load-parity.json
