...
> **Status: Archive / INVESTIGATION** — post-ship fault isolation package; not product law.  
> Index: [../README.md](../README.md). Prefer code on `working` and living DESIGN under `docs/design/memory/`.

| Field | Value |
|-------|--------|
| **Class** | INVESTIGATION |
| **Status** | Archive (WP1–WP2 sealed; WP3 live skipped) |
| **Audience** | Archaeology / meal continuity implementers |
| **Normative?** | No |
...
| **Moved from** | `docs/stretch-2/meal-continuity-review/` (docs reorg PR5 / #121) |
