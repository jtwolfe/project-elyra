...
> **Status: Archive / INVESTIGATION** — host-specific freezes; not portable env restore.  
> Operator start path: [../../state/radeon-vii/README.md](../../state/radeon-vii/README.md). Index: [../README.md](../README.md).
...
| **Class** | INVESTIGATION |
| **Status** | Archive |
| **Audience** | LuxPrimata operators / archaeology |
| **Normative?** | No — freezes are host-specific |
| **Moved from** | `docs/radeon-vii-dev/freezes/` (docs reorg PR5 / #121) |
...
| Keep freezes under `docs/investigations/radeon-vii-freezes/` only | Scatter freezes into product package paths |
