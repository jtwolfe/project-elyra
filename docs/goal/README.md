...
**Pre-move index only.** Files below still live at their current paths — they are **not** yet under `docs/goal/`. Short north-star pages land in PR3 of [#121](https://github.com/jtwolfe/project-elyra/issues/121). Prefer the [docs hub](../README.md).

Product direction (*what* / *why* — keep short; designs stay DESIGN):
...
Full designs: [../design/README.md](../design/README.md).
