...
|-------|--------|
| **Class** | GOAL |
| **Status** | Active (soft guidance only) |
| **Audience** | Product / Implementers (judgment) |
| **Normative?** | **No** — not a phase plan, not acceptance criteria |
| **Primary philosophy** | [memory-atoms.pdf](../memory-atoms.pdf) — *What is wrong with my memory?* |
| **Related** | [inspiration-activity-model-and-storage.md](../stretch-2/inspiration-activity-model-and-storage.md) · [stretch-2-north-star.md](stretch-2-north-star.md) |
...
| [inspiration-activity-model-and-storage.md](../stretch-2/inspiration-activity-model-and-storage.md) | Operational baseline (activities, data prototype, storage needs) |
...
| [stretch-2 phase designs](../state/memory/README.md) | Concrete phase design; this file does not override them |
