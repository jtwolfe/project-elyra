# v0.1 discussion — promotion close & long-term gym

| Field | Value |
|-------|--------|
| **Class** | GOAL |
| **Status** | Active (long-form discussion; not a freeze contract) |
| **Audience** | Product |
| **Normative?** | No — short claim [v0.1.md](v0.1.md) + #112 are claim entry; prefer code on `working` |
| **Created** | 2026-07-30 |
...
| **Related** | Short claim [v0.1.md](v0.1.md) · epic [#111](https://github.com/jtwolfe/project-elyra/issues/111) · exit criteria [#112](https://github.com/jtwolfe/project-elyra/issues/112) |

> **Short claim first:** [v0.1.md](v0.1.md) (GOAL entry). This file is the **long-form** promotion / gym discussion (moved from `docs/promotion-discussion/README.md`). When it conflicts with Stretch 1 runtime rules, [stretch-1.md](../stretch-1.md) wins.

> **Tip supersession:** Normative integration tip is **`working`** (not sole day-to-day use of `main`, and not historical `grok-improvement`). Full tip / promote / pin / tag / stale-stack law: **[docs/branch-law.md](../dev/branch-law.md)**. Multi-party process still lives in [development-governance.md](../dev/development-governance.md).

Long-form home for **promotion / v0.1** thinking: what we have, what remains, meal/context limits, and how to track everything that landed in ~1–2 weeks of dense build.

**Index**

| Doc | Role |
|-----|------|
| **[v0.1.md](v0.1.md)** | **Short claim** — In/Out + success bars (GOAL entry) |
| **This file** | Charter, roadmap reflection, GitHub Project, meal reconstruction & budgets |
...
Related: [project-status-pass.md](../project-status-pass.md) (stale snapshot), [stretch-2/README.md](../state/memory/README.md), [grok-improvement-plan/README.md](../grok-improvement-plan/README.md), [known-bugs.md](../state/known-bugs.md), [radeon-vii-dev/README.md](../radeon-vii-dev/README.md), [branch-law.md](../dev/branch-law.md).

**Programme name (working):** *Project Elyra — Autopoiesis Commons* (runtime stays “Elyra”; short label *Autopoiesis Commons* / *Elyra AC* — see [governance §6](../promotion-discussion/development-governance.md#6-naming--project-identity)).
...
> **Packaging In/Out superseded** by short claim [v0.1.md](v0.1.md) / [#112](https://github.com/jtwolfe/project-elyra/issues/112) (operator lock **2026-08-04**). Sections §2.3–2.6 below are **historical deliberation** (2026-07-30): e.g. Phase 3 “may defer” was revised — short claim **In #2** keeps Phase 3 **functional but experimental** (C11/#117); multi-user, meal construction, and edges also landed on the short In table. Prefer [v0.1.md](v0.1.md) for current claim text.

**In (historical 2026-07-30):**
...
**Out of v0.1 (historical default):**
...
> **Superseded for packaging claim:** short [v0.1.md](v0.1.md) **In #2** keeps Phase 3 **functional but experimental** (C11/#117); **procedural polish** stays **v0.2**. The paragraph below is the earlier 2026-07-30 defer deliberation.
...
→ [`docs/stretch-2/design-instance-continuity-glass-tail-directed-keep.md`](../design/memory/design-instance-continuity-glass-tail-directed-keep.md)

Review methodology (execute next):

→ [`docs/stretch-2/design-meal-formation-continuity-review-plan.md`](../design/memory/design-meal-formation-continuity-review-plan.md)
