...
Which [§3 activities](../inspiration-activity-model-and-storage.md) are live after Phase 1.
...
| Document | Role |
|----------|------|
| [design-phase-1-implementation.md](../design-phase-1-implementation.md) | Implementation design, key decisions, promote rules R1–R10 |
| [design-phase-1-temporal.md](../design-phase-1-temporal.md) | Short phase outline (superseded for implement detail) |
| [design-context-meal-composition.md](../design-context-meal-composition.md) | Meal channels, slide-off, re-gather sketch |
| [design-database-choices.md](../design-database-choices.md) | Future Lance path; Protocol boundary |
