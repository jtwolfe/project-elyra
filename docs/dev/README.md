...
| Doc | Role | Status |
|-----|------|--------|
| [engineering-principles.md](engineering-principles.md) | How we write code — modules, tests, config, dogfood; **§10** docs taxonomy | Active |
...
Taxonomy / freeze / supersede rules: [engineering-principles.md](engineering-principles.md) **§10** (PR6 of [#121](https://github.com/jtwolfe/project-elyra/issues/121)). Full design + decision tree: [docs-reorg-taxonomy.md](../design/docs-reorg-taxonomy.md).
