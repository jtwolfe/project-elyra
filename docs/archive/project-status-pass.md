...
> **Status: Archive** — 2026-07-26 snapshot; tip names lag (`grok-improvement`).  
> Prefer root [README.md](../../README.md), board, and [STATE](../state/README.md). Not build law.

| Field | Value |
|-------|--------|
| **Class** | ARCHIVE |
| **Status** | Archive (stale snapshot) |
| **Audience** | Archaeology |
| **Normative?** | No |
| **Date** | 2026-07-26 |
| **Branch tip** | `grok-improvement` (product integration branch; `main` is behind) — **historical; tip law is `working`** |
...
| **Moved from** | `docs/project-status-pass.md` (docs reorg PR5 / #121) |

This is a **status and orientation** note, not a freeze contract. When it conflicts with [stretch-1.md](../state/stretch-1.md) on Stretch 1 runtime rules, stretch-1 wins.
