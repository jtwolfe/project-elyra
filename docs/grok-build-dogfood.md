...
| **Functionalization** | [design-grok-build-functionalization.md](design-grok-build-functionalization.md) (auth seed + zombie/finalize honesty) |
...
| **D7 enable non-experimental** | Signed strategy (1) or (2) in [grok-build-headless-spike.md](grok-build-headless-spike.md); until then **experimental only** |
...
- [ ] **D1 — `mode=prompt` “summarize README” in repo** ⚠️ **required on advanced feature tip before PR8 discussion**  
  ...
  Design: [Dogfood matrix D1](design-grok-build-tool.md). Functionalization: auth seed must allow cold-start.
...
- [ ] **D12 — Mid-run auth**  
  ...
  Design: [Dogfood matrix D12](design-grok-build-tool.md); spike auth notes; functionalization KD-F2.
...
- [ ] **D13 — Reaper restart** (preferred with D1)  
  ...
  Design: [Dogfood matrix D13](design-grok-build-tool.md); functionalization KD-F6/F14.
...
| `docs/design-grok-build-functionalization.md` | Auth seed + zombie/finalize design (PR-A…E) |
